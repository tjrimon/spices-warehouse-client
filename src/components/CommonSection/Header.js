    ...
    return (
        <div className='bg-indigo-500'>
            <div className='shadow-lg py-3 flex items-center justify-between container mx-auto'>
                ...
                <ul className={`main-menu md:flex absolute md:static ${menuOpen ? 'top-14' : 'top-[-200px]'} bg-indigo-700 md:bg-indigo-500 text-white w-full md:w-auto p-5 md:p-0 left-0 duration-200 ease-in`}>
                    ...
                    <li className='px-3 hover:bg-indigo-700 mr-2.5 md:text-white rounded py-2'>
                        {user ?
                            ...
                            : <><FontAwesomeIcon icon="fa fa-sign-in"></FontAwesomeIcon> <NavLink className='pl-1' to='/login'>Login</NavLink> </>
                        }
                    </li>
                </ul>
                <div onClick={() => {
